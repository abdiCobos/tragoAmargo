...
const translations = {
  es: {
    ...
    about_p1: "<strong>Trago Amargo</strong> nace de una frustración compartida: apps donde cada cafetería tiene 4.8 estrellas y al llegar el café sabe a quemado.",
  ...
  en: {
    ...
    about_p1: "<strong>Trago Amargo</strong> was born out of a shared frustration: apps where every coffee shop has 4.8 stars and upon arrival the coffee tastes burnt.",
